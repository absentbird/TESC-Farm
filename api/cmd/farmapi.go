...
import (
  ...
  //NOTE: use of modules makes it difficult to utilize relative import paths.
  //This is only really needed for dynamic generation of swagger endpoint info
  //if you can figure out how this thing works in mod.go then go for it,
  //until then its staying commmented out.
  //if you want to make this work add "replace farmapi/docs => ./cmd/docs" to mod.go
  //"farmapi/docs" // docs is generated by Swag CLI, you have to import it.
)

//@title              General API for TESC Farm
//@version            1.0
//@description        This API is responsible for tracking labor, inventory, and productivity for TESC.
