...
func main() {
	...
	auth.GET("/hours/:id/delete", labor.DeleteHours)
	...
	auth.GET("/team/:id/delete", labor.DeleteTeam)
	...
	auth.GET("/task/:id/delete", labor.DeleteTask)
	...
	auth.GET("/worker/:id/delete", labor.DeleteWorker)
	...
	auth.GET("/crop/:id/delete", harvest.DeleteCrop)
	...
	auth.GET("/planting/:id/delete", harvest.DeletePlanting)
	...
	auth.GET("/harvest/:id/delete", harvest.DeleteHarvest)
	...
	auth.GET("/process/:id/delete", harvest.DeleteProcessing)
	...
	auth.GET("/product/:id/delete", sales.DeleteProduct)
	...
	auth.GET("/sale/:id/delete", sales.DeleteSale)
